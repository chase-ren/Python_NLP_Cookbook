...
from Ch1_NLP_Basics.tokenization import tokenize_nltk
from Ch1_NLP_Basics.dividing_into_sentences import divide_into_sentences_nltk
from Ch4_Classifying_Texts.preprocess_bbc_dataset import get_data
from Ch4_Classifying_Texts.keyword_classification import divide_data
from Ch4_Classifying_Texts.preprocess_bbc_dataset import get_stopwords

bbc_dataset = "Data/bbc-text.csv"
...
def main():
    ...
    pickle.dump(km, open("Ch4_Classifying_Texts/bbc_kmeans.pkl", "wb"))
